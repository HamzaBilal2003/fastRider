...
import UserChat from '../../pages/support/components/UserChat';
import SupportHeader from '../../pages/support/components/SupportHeader';
import { useQuery } from '@tanstack/react-query';
import { fetchcustomerChat, UserChatData } from '../../queries/rider/riderDetail';
import { useParams } from 'react-router-dom';
import Loader from '../../components/Loader';
import { API_DOMAIN_Img } from '../../apiConfig';
import UserMessageChat from '../../pages/riderProfile/component/UserMessageChat';
...
const UserChatMessage: React.FC = () => {
    ...
    const { data: chats, isLoading, error } = useQuery({
        queryKey: ['chats'],
        queryFn: () => fetchcustomerChat(Number(username)),
    });
    console.log(chats)
    ...
    return (
        <>
        <ProfileHeader url={'chat'} userId={username}  />
