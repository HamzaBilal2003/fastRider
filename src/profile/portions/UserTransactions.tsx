...
import { fetchUserTransactions, Transaction } from '../../queries/user/UserDetail';
...
const UserTransactions: React.FC = () => {
    ...
    const { data: rawUserTransaction, isLoading, error } = useQuery({
        ...
        queryFn: () => fetchUserTransactions(Number(username)),
    ...
    const filteredTransactions = useMemo(() => {
        ...
        // 
    }, [activeType, activeStatus,searchQuery, activePeriod,  rawUserTransaction]);
    // activeRole,
    ...
    return (
        <>
            <ProfileHeader url='transaction' userId={username} handlePeriod={handleDetailsClick} />
